...
- The absolute p99 table has overlapping three-trial ranges in `7/16` comparisons, including two tensor-core cells whose median direction favors FlashDec. With 50 repeats per row, p99 is close to a sample maximum; this baseline therefore makes no stable or production tail-latency claim.
