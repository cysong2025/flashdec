"""Run paged decode attention warp-sweep experiments."""
...
def _common_metadata(torch, args, dtype_name, impl, case_name, sweep, shape, seq_lens, block_tables, cache):
    ...
    return {
        ...
        "benchmark": getattr(args, "benchmark", "paged_decode_warp_sweep"),
...
def parse_args():
    ...
    parser.add_argument(
        "--output",
        default="benchmarks/results/paged_decode_warp_sweep.csv",
    )
