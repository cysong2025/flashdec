...
| R4-A RTX quick | provisional p50/TPS `1.7856x/1.8755x`；scalar extraction `20/20 -> 0/0` | wall/CPU/scalar 方向保留；旧 device/event 口径撤回，等待 canonical profiler 复测 |
