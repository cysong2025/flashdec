...
| R4-A RTX quick | p50/TPS `1.7856x/1.8755x`；scalar extraction `20/20 -> 0/0` | 单 case、单 dtype、单 trial 严格 gate 通过；正式稳定性待 5-trial 全矩阵 |
