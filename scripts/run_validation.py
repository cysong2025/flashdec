"""Run reproducible FlashDec validation phases and export result artifacts."""
        ...
        "trials-quick": (
            ValidationStep(
                ...
                (
                    ...
                    "both",
                    "--output",
                    "benchmarks/results/decode_engine_workload_trials2_quick.csv",
                ),
                ("benchmarks/results/decode_engine_workload_trials2_quick.csv",),
            ),
            ValidationStep(
        ...
        "trials-formal": (
            ValidationStep(
                ...
                (
                    ...
                    "both",
                    "--output",
                    "benchmarks/results/decode_engine_workload_trials3.csv",
                ),
                ("benchmarks/results/decode_engine_workload_trials3.csv",),
            ),
            ValidationStep(
        ...
        "profile-quick": (
            ValidationStep(
                ...
                (
                    ...
                    "--export-trace",
                    "--output-dir",
                    "benchmarks/profiles/decode_engine_quick",
                    "--summary-output",
                    "benchmarks/results/decode_engine_stage_profile_quick_summary.md",
                ),
                ("benchmarks/results/decode_engine_stage_profile_quick_summary.md",),
            ),
        ),
        "profile-formal": (
            ValidationStep(
                ...
                (
                    ...
                    "fused_cuda",
                    "--output-dir",
                    "benchmarks/profiles/decode_engine",
                    "--summary-output",
...
def main():
    ...
    try:
        ...
        if not args.dry_run and any(phase in GPU_PHASES for phase in phases):
            ...
            env = dict(os.environ)
        print(f"FlashDec validation commit: {commit}", flush=True)
