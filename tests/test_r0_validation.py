"""Dependency-free coverage for the R0 validation orchestrator."""
...
from scripts.run_r0_validation import (
    ALL_EVIDENCE_PHASES,
    ValidationStep,
    artifact_signatures,
...
class R0ValidationOrchestratorTests(unittest.TestCase):
