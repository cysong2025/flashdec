...
| Trusted Transaction R4 | checked public raw op、Cache-owned device-value-check-free path、persistent metadata、统一多层调度证据 | R4-A correctness、CPU-only attribution 与 160-row 正式矩阵完成并冻结；当前进入独立 R4-B |
