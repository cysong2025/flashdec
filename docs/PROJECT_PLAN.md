...
| Trusted Transaction R4 | checked public raw op、Cache-owned device-value-check-free path、统一多层调度证据 | R4-A 实现/harness 与 RTX focused correctness 完成；quick profiler 修复后待重跑 |
