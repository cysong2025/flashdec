...
| Trusted Transaction R4 | checked public raw op、Cache-owned device-value-check-free path、统一多层调度证据 | R4-A 实现/focused correctness 与 CPU-only profiler 修复完成；待 RTX l4 stress 与正式矩阵复测 |
