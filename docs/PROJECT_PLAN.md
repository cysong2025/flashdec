...
| Trusted Transaction R4 | checked public raw op、Cache-owned device-value-check-free path、persistent metadata、统一多层调度证据 | R4-A 完成并冻结；R4-B 正式稳定性门失败后恢复 materialized 默认；当前进入 R4-C |
